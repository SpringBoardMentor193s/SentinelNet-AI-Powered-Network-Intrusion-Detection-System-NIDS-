...
- `data/` → Raw and processed datasets (NSL-KDD, CICIDS2017)
- `notebooks/` → Jupyter notebooks for exploratory data analysis (EDA), model training & experiments
- `scripts/` → Python scripts for preprocessing, training, and evaluation
- `docs/` → Documentation (data overview, methodology, reports)